...
FEATURE_LABELS = {
    ...
    "surface_hard": ("context", "Surface : dur"),
    "surface_clay": ("context", "Surface : terre battue"),
    "surface_grass": ("context", "Surface : gazon"),
    "level_g": ("context", "Niveau : Grand Chelem"),
    "level_m": ("context", "Niveau : Masters 1000"),
    "level_a": ("context", "Niveau : ATP 250/500"),
    "level_f": ("context", "Niveau : Masters de fin d'année"),
    "level_d": ("context", "Niveau : Coupe Davis"),
    "level_o": ("context", "Niveau : Jeux olympiques"),
